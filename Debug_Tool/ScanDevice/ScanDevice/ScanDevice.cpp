...
// ScanDevice.cpp : Defines the class behaviors for the application.
//
...
// The one and only CScanDeviceApp object

CScanDeviceApp theApp;


// CScanDeviceApp initialization
